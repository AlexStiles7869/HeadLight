...
\begin{appendices}
    \section{Applications of the Design Toolkit}
        % \begin{table}[H]
            ...
            \caption{Applications of the Design Toolkit.}\\
            \label{table:designtoolkit}\\
                % \toprule\endhead
                ...
                Strategy & Get another perspective & Both the PCB and the schematic were checked by people other than the designer. \\
                Design Principle &  &  \\
                Design Principle &  &  \\
